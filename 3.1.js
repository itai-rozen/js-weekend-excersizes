...
console.log('expected: 3. got: ',nb_year(1000,2,50,1200))
console.log('expected: 15. got: ',nb_year(1500, 5, 100, 5000))
console.log('expected: 10. got: ',nb_year(1500000, 2.5, 10000, 2000000))