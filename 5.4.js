...
const toWeirdCase = str => {
    ...
    for (let letter of str){
        newStr +=  (index % 2 === 0)  ? letter.toUpperCase() : letter.toLowerCase()
        index++
    }
    return newStr
}

let string = 'what a weird case string this is'
console.log('original string: ', string)
console.log('string after weird casing: ',toWeirdCase(string))