...
console.log('expected: 5. got:',getSleepyPassangers(passangers))
console.log(`The busdriver needs to wake up ${getSleepyPassangers(passangers)} sleepy passangers.`)
